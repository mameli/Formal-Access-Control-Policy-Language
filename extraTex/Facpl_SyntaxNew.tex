...
&& & \Sep [ \, \mathit{Effect} \ \ \mathit{ObType} \ \ \mathit{(Expr)}^* \ \ \mathit{CheckValue}^?\, ]\\
\\[.2cm]
...
\mathit{Name} & ::= & \mathit{Identifier}/\mathit{Identifier} \ | \ \mathit{Status}/\mathit{Identifier}\\[.1cm]
%
\textbf{Check Values} &
\mathit{cValue} & ::= & \mathit{Int} \mid \mathit{StringDate}\\[.1cm]
%
