...
\newcommand{\myIjava}[5]
	{
		\lstinputlisting[language = Java, style = javigno, firstline = #3, lastline = #4, caption = {#2}\label{lst:#5}]{./code/cap5/#1}
	}
\newcommand{\myjava}[2]
	{
		\lstinputlisting[language = Java, style = javigno, caption = {#2}\label{lst:#1}]{./code/cap5/#1}
	}
%--------------------------------------------------------------
% Layout setting
%--------------------------------------------------------------
