...
\newcommand{\javaFirstline}[4]
	{
		\lstinputlisting[language = Java, style = monokai, firstline = #2, lastline = #3,firstnumber=1]{./code/cap5/#1}\label{lst:#4}
	}
\newcommand{\javaLastline}[4]
	{
		\lstinputlisting[language = Java, style = monokai, firstline = #2, lastline = #3,firstnumber=last]{./code/cap5/#1}\label{lst:#4}
	}
\newcommand{\javaFirstlineN}[5]
	{
		\lstinputlisting[language = Java, style = monokai, firstline = #2, lastline = #3,firstnumber=#5]{./code/cap5/#1}\label{lst:#4}
	}
\newcommand{\javaFirstlineC}[5]
	{
		\lstinputlisting[language = Java, style = monokai, firstline = #3, lastline = #4,firstnumber=1, caption = {#2}\label{lst:#5}]{./code/cap5/#1}
	}
\newcommand{\javaLastlineC}[5]
	{
		\lstinputlisting[language = Java, style = monokai, firstline = #3, lastline = #4,firstnumber=last, caption = {#2}\label{lst:#5}]{./code/cap5/#1}
	}
\newcommand{\javaFirstlineNC}[6]
	{
